...
namespace FS.Utils.Web.Common
{
    ...
    public abstract class Sessions : IRequiresSessionState
    {
        ...
        {
            if (isAddPrefix) { strName = WebSystemConfigs.ConfigEntity.Session_Prefix + strName; }
            var t = defValue;
        ...
        public static void Set(string strName, object value, bool isAddPrefix = true)
        {
            ...
            HttpContext.Current.Session.Timeout = WebSystemConfigs.ConfigEntity.Session_TimeOut;
